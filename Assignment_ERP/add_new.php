...
if(isset($_POST['submit'])){
    ...
    $sql = "INSERT INTO `customer`(`id`, `title`, `first_name`, `last_name`, `contact_no`, `district`) 
    VALUES (NULL,'$title','$first_name','$last_name','$contact_no','$district')";
    

    $result = mysqli_query($conn, $sql);

    if($result) {
        header("Location: index.php?msg=New record created successfullly");
    }
    else {
